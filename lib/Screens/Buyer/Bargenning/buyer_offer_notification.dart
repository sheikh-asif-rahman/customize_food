...
import 'package:customize_food/Screens/Buyer/Bargenning/offer_detail.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';

class BuyerOfferNotification extends StatefulWidget {
  const BuyerOfferNotification({super.key});

  @override
  State<BuyerOfferNotification> createState() => _BuyerOfferNotificationState();
}

class _BuyerOfferNotificationState extends State<BuyerOfferNotification> {
  List orderList = [];
  List sellermails = [];
  List itemName = [];
                    ...
                    subtitle: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            orderList[index]["buyer_offer"].toString(),
                            style: const TextStyle(
                                fontSize: 18, fontWeight: FontWeight.bold),
                          ),
                          const Text(
